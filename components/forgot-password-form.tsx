      ...
      {success ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Se han enviado instrucciones para restablecer tu contraseña</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Si te registraste usando tu correo electrónico y contraseña,
